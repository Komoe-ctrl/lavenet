...
const envSchema = z.object({
  ...
  // F-PAY-03. Signs/verifies the payment webhook -- generated by us, never
  // a third-party API key (CLAUDE.md §11: the demo runs with none). Same
  // secret signs the sandbox provider's own simulated callbacks, so the
  // webhook handler exercises its real verification path even in demo mode.
